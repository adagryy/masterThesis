function [] = cale_szkielko(imageSource, imageDestination, afterProcessingData)
    ...
    table = length_calculation(table_1, table_2);
    ...
    % save data to JSON
    totalAmount = 'Ilosc_Paleczek';
    totalAmountValue = size(results,1);
    data = 'data';
    dataValue = results;
    s = struct(totalAmount, totalAmountValue, data, dataValue);
...
function [final_table] = length_calculation(table_1, table_2) 
    ...
    % nast�pnie z pomoc���redniej wa�onej odrzucamy niepe�ne pr�bki
